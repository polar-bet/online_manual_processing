        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Таблиця з розділами прикладів</h3>
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        @foreach($sections as $section)
                            <tr>
                                ...
                                <td>
                                    <form action="{{route('admin.example.section.delete', $section->id)}}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <div class="btn-group">
                                            <a href="{{route('admin.example.section.edit', $section->id)}}"
