...
class UpdateRequest extends FormRequest
{
    ...
    {
        return [
            'name' => 'required|string|unique:example_articles,name,' . $this->article->id . ',id,deleted_at,NULL|max:100',
            'description' => 'required|string|max:5000',
            'image' => 'nullable|image|mimes:png,jpg,svg,gif,jpeg,webp|max:8192',
